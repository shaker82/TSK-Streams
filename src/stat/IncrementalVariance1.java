...
public class IncrementalVariance1 {
	...
	public static void main(String[] args) {
		...
		IncrementalVariance1 incVariance = new IncrementalVariance1() ; 
		int number = 1000 ;
...
*/
		...
		incVariance = new IncrementalVariance1(temp) ;
	...
	public IncrementalVariance1()
	{
		
	}
	
	public IncrementalVariance1(double [] arrayV)
	{
		array= arrayV ;
		size= arrayV.length ;
		index = 0 ;
